import { z } from 'zod';
import { i as isActionAPIContext, a as apiContextRoutesSymbol, b as shouldAppendForwardSlash, A as ACTION_API_CONTEXT_SYMBOL, h as hasContentType, f as formContentTypes } from './index_5TTboWV6.mjs';
import { A as AstroError, k as ActionNotFoundError, l as ActionCalledFromServerError } from './astro/server_ax9D0Zyw.mjs';
import { r as removeTrailingForwardSlash } from './path_BuZodYwm.mjs';
import { c as callSafely, A as ActionError, a as ActionInputError, d as deserializeActionResult, s as serializeActionResult, b as ACTION_RPC_ROUTE_PATTERN, e as ACTION_QUERY_PARAMS } from './astro-designed-error-pages_B-JG_Df2.mjs';

async function getAction(path) {
  const pathKeys = path.split(".").map((key) => decodeURIComponent(key));
  let { server: actionLookup } = await import('./_astro_internal-actions_DvxcSdbF.mjs');
